...
const STEP_ROUTES = [
  ...
  "/attribution-lite/new?step=placement",
    ...
    <div className="flex min-h-screen flex-col bg-white font-sans">
      <header className="flex h-14 items-center justify-between border-b border-[#e0e0e0] bg-white px-12">
        <div className="flex items-center gap-16">
          <Link href="/attribution-lite" className="flex items-center gap-0.5 font-mono text-lg font-medium text-[#000033] no-underline">
            <span>FSQ</span>
            <span>/</span>
        ...
        <div className="flex items-center justify-between px-12 py-2.5">
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {submitted && (
                <button onClick={() => router.push("/attribution-lite?submitted=mcdonalds-q1-q2-2025")} className="rounded-md bg-[#212be9] px-3 py-1 text-sm font-medium text-white hover:bg-[#1a22c4] transition-colors">Back to Main</button>
              )}
            </div>
            {!submitted && (
        ...
        <main className="relative min-w-0 flex-1">
          ...
          <div className="mb-8">
            ...
            <div className="mb-4 flex items-start gap-2 rounded-lg border border-[#bfdbfe] bg-[#eff6ff] px-4 py-3">
              ...
              <p className="text-sm text-[#020617]">
                Partners listed on this campaign will immediately be notified to confirm funding and other information regarding the ad campaign details and funding*.
              </p>
            </div>
          ...
          {!submitted ? (
            <div className="flex items-center justify-between py-4">
              <Link
                href="/attribution-lite/taxonomy"
            ...
            <div className="flex items-center py-4">
              <button
                onClick={() => router.push("/attribution-lite?submitted=mcdonalds-q1-q2-2025")}
